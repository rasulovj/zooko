...
export default function Home() {
  return (
    <div className="min-h-screen bg-[var(--background)]">
      {/* Nav */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[var(--background)]/80 backdrop-blur-xl border-b border-green-600/5">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <span className="text-xl font-bold tracking-tight text-green-900" style={{ fontFamily: "var(--font-display)" }}>
              zooko
            </span>
          </Link>
          <div className="hidden md:flex items-center gap-8 text-sm text-green-900/60">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/login"
              className="text-sm font-medium bg-green-600 text-white px-5 py-2.5 rounded-full hover:bg-green-900 transition-colors"
            >
              Kirish
            </Link>
          </div>
      ...
      <section className="relative pt-32 pb-20 md:pt-44 md:pb-32 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-20 right-[10%] w-72 h-72 bg-green-50 rounded-full blur-3xl opacity-60 animate-float" />
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="max-w-2xl">
            <div className="animate-fade-in-up">
              <span className="inline-flex items-center gap-1.5 text-xs font-medium tracking-wide uppercase text-green-600 bg-green-50 px-3 py-1.5 rounded-full mb-6">
                <span className="w-1.5 h-1.5 bg-green-300 rounded-full" />
                Bolalar uchun ta'lim platformasi
              </span>
            </div>
            <h1
              className="text-5xl md:text-7xl font-extrabold leading-[1.05] tracking-tight text-green-900 animate-fade-in-up delay-100"
              style={{ fontFamily: "var(--font-display)" }}
            >
              Informatika,{" "}
              <span className="text-green-600">qiziqarli</span> har bir bola uchun
            </h1>
            <p className="mt-6 text-lg md:text-xl text-green-900/55 leading-relaxed max-w-lg animate-fade-in-up delay-200">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 animate-fade-in-up delay-300">
              <Link
                href="/login"
                className="inline-flex items-center justify-center gap-2 bg-green-600 text-white font-semibold px-8 py-4 rounded-full text-base hover:bg-green-900 transition-all hover:shadow-lg hover:shadow-green-600/20"
              >
                Kirish
              ...
              <a
                href="#features"
                className="inline-flex items-center justify-center font-medium px-8 py-4 rounded-full text-base text-green-900 border border-green-900/10 hover:border-green-600/30 hover:bg-green-50/50 transition-all"
              >
          ...
          <div className="hidden lg:block absolute top-8 right-0 w-[380px] animate-fade-in delay-500">
            <div className="relative">
              <div className="bg-white rounded-3xl border border-green-600/10 p-6 shadow-xl shadow-green-900/5">
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-10 h-10 rounded-full bg-green-50 flex items-center justify-center text-lg">🧒</div>
                  <div>
                    <p className="text-sm font-semibold text-green-900">Alining natijasi</p>
                    <p className="text-xs text-green-900/40">3-daraja · Algoritmlar</p>
                  </div>
                </div>
                <div className="space-y-3">
                  <div>
                    <div className="flex justify-between text-xs mb-1">
                      <span className="text-green-900/60">Saralash asoslari</span>
                  ...
                  <div>
                    <div className="flex justify-between text-xs mb-1">
                      <span className="text-green-900/60">Mantiqiy elementlar</span>
                  ...
                  <div>
                    <div className="flex justify-between text-xs mb-1">
                      <span className="text-green-900/60">Ikkilik sonlar</span>
                ...
                <div className="mt-5 flex items-center gap-2 text-xs text-green-600 bg-green-50 rounded-xl px-3 py-2">
                  <span>🏆</span>
                  <span>Bu hafta 3 ta nishon olindi!</span>
                </div>
              </div>
              <div className="absolute -bottom-4 -left-4 bg-white rounded-2xl border border-green-600/10 px-4 py-3 shadow-lg shadow-green-900/5 animate-float delay-700">
                <p className="text-xs font-medium text-green-900">🎯 Keyingi: Rekursiya</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="features" className="py-20 md:py-28">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center max-w-xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-green-900 tracking-tight" style={{ fontFamily: "var(--font-display)" }}>
              Sinfingiz uchun zarur bo'lgan hamma narsa
            </h2>
            <p className="mt-4 text-green-900/50 text-lg">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              <div
                key={i}
                className="group bg-white border border-green-600/5 rounded-2xl p-7 hover:border-green-600/15 hover:shadow-lg hover:shadow-green-900/5 transition-all duration-300"
              >
                <div className="w-11 h-11 rounded-xl bg-green-50 text-green-600 flex items-center justify-center mb-5 group-hover:bg-green-600 group-hover:text-white transition-colors duration-300">
                  {f.icon}
                </div>
                <h3 className="font-semibold text-green-900 text-base mb-2">{f.title}</h3>
                <p className="text-sm text-green-900/50 leading-relaxed">{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* How It Works */}
      <section id="how-it-works" className="py-20 md:py-28 bg-green-50/30">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center max-w-xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-green-900 tracking-tight" style={{ fontFamily: "var(--font-display)" }}>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="relative text-center md:text-left">
                ...
                <p className="text-sm text-green-900/50 leading-relaxed">{s.desc}</p>
                {i < 2 && (
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-6xl mx-auto px-6">
          <div className="bg-green-900 rounded-3xl p-10 md:p-16 text-center relative overflow-hidden">
            <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="relative">
              <h2 className="text-3xl md:text-4xl font-bold text-white tracking-tight mb-4" style={{ fontFamily: "var(--font-display)" }}>
                Informatikani qiziqarli qilishga tayyormisiz?
              </h2>
              <p className="text-green-300/80 text-lg mb-8 max-w-md mx-auto">
                O'qituvchingizdan kirish ma'lumotlarini so'rang va bugun informatikani o'rganishni boshlang.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/login"
                  className="inline-flex items-center justify-center gap-2 bg-green-300 text-green-900 font-semibold px-8 py-4 rounded-full hover:bg-white transition-colors"
                >
                  Kirish
      ...
      <footer className="border-t border-green-900/5 py-10">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold text-green-900" style={{ fontFamily: "var(--font-display)" }}>zooko</span>
          </div>
          <p className="text-xs text-green-900/35">
